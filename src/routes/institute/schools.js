...
import SchoolInfo from "../../components/Institute/SchoolInfo";
    ...
    return (
        <Main>
            ...
            <div className="w-100">
                ...
                <Content>
                    {showCom ? (
                        <SchoolInfo toreq={idToReq} data={driverInfo} />
                    ) : (
                        <>
                            <div className="cards">
                                {activeTable !== 1 && (
                                    <Card className="bg-red">
                                        ...
                                        <div>
                                            ...
                                            <span className="title">
                                                مدارس فعال({activeSchool})
                                            </span>
                                            <span className="span">
                                                مدارسی که در حال همکاری با شما
                                                هستند
                                            </span>
                                        </div>
                                        <button
                                ...
                                {activeTable !== 2 && (
                                    <Card className="bg-blue">
                                        ...
                                        <div>
                                            ...
                                            <span className="title">
                                                مدارس در انتظار تایید(
                                                {pendingSchool})
                                            </span>
                                            <span className="span">
                                                مدارس در انتظار تایید برای
                                                همکاری با شما
                                            </span>
                                        </div>
                                        <button
                                ...
                                {activeTable !== 0 && (
                                    <Card className="bg-green">
                                        ...
                                        <div>
                                            ...
                                            <span className="span">
                                                مدارس در انتظار تا و مدارس فعال
                                            </span>
                                        </div>
                                        <button
                                            onClick={() => {
                                ...
                                {activeTable !== 3 && (
                                    <Card className="bg-red">
                                        ...
                                        <div>
                                            ...
                                            <span className="title">
                                                مدارس رد شده({rejectedSchool})
                                            </span>
                                            <span className="span">
                                                مدارس رد شده توسط موسسه.
                                            </span>
                                        </div>
                                        <button
                                            onClick={() => {
                            ...
                            {activeTable == 0 ? (
                                ...
                                <TableDiv>
                                    <div className="head">
                                        <h6>مدارس رد شده({rejectedSchool})</h6>
                                        <div className="tabs">
                                            <span
                                                className={
                                                    activeTab === 1 && ""
