        ...
        axios(infoConfig)
            .then((res) => {
                ...
                axios(config)
                    ...
                    .catch((error) => {});
                let config2 = {
                    url: `${BASE_URL}get-detilse-trip/institution{}?id_institution=${res.data.InstitutionManageCurrentDetails.id}`,
                    method: "GET",
                };
                axios(config2)
                    .then((ress) => {
                        setTravels(
                            ress.data.ListTripInstitution
                        );
                    })
                    .catch((error) => {});
                    let config3 = {
                    ...
                    axios(config3)
                        .then((ress) => {
                            setSchools(ress.data.ListSchool);
                        })
                        .catch((error) => {});
            })
            .catch((error) => {});
                    ...
                    <div className="cards">
                        <Card className="bg-red">
                            ...
                            <div>
                                ...
                                <span className="title">
                                    سفرها (
                                    {travels !== undefined && travels.length})
                                </span>
                        ...
                        <Card className="bg-blue">
                            ...
                            <div>
                                ...
                                <span className="span">
                                    مدارسی که با موسسه شما همکاری دارند
                                </span>
                            </div>
                            <button
                                onClick={() => {
