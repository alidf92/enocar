...
import PmDetails from "../../components/School/PmDetails";
                            ...
                            {activePage == 1 ? (
                                <FaqDiv>
                                    ...
                                    <div className="content">
                                        <h6>
                                            لورم ایپسوم یک متن ساختگی (دسته
                                            بندی)
                                        </h6>
                                        <div className="item">
                                            <div
                                            ...
                                            >
                                                <p>
                                                    ...
                                                    تا با نرم افزارها شناخت
                                                    بیشتری را برای طراحان رایانه
                                                    ای علی الخصوص طراحان خلاقی،
                                                    و فرهنگ پیشرو در زبان فارسی
                                                    ایجاد کرد، در این صورت می
                                                    توان امید داشت که تمام و
                                                    دشواری موجود در ارائه
                                                    راهکارها، و شرایط سخت تایپ
                                                    به پایان رسد و زمان مورد
                                                    نیاز شامل حروفچینی
                                                    دستاوردهای اصلی، و جوابگوی
                                                    سوالات پیوسته اهل دنیای
                                                    موجود طراحی اساسا مورد
                                                    استفاده قرار گیرد.(پاسخ)
                                                </p>
                                            </div>
                                        </div>
                                        <div className="item">
